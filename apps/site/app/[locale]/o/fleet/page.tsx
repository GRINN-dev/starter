...
const Fleet = () => {
  ...
  return (
    ...
    <>
    <h1 className="text-3xl font-bold tracking-tight ml-6 my-6 text-center lg:text-start ">Flotte de véhicule</h1>
      {csvFile ? (
        <>
        ...
        <CardHeader className="p-2">
            <CardTitle className="text-center py-2 lg:text-lg lg:my-4">Tableau de la flotte de véhicule</CardTitle>
          </CardHeader>
